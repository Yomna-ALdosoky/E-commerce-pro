        ...
        <div class="content-wrapper">
          ...
          @endif
            ...
            <div class="div_design">
              ...
              <input class="text_color" type="number" name="dis_price" placeholder="Write A Discount is ap" value="{{$product->discount_price}}">
            </div>

            <div class="div_design">
              <label>Product Quantity :</label>
              <input class="text_color" type="number" name="quantity" placeholder="Write A Discount is apply" required="" value="{{$product->quantity}}">
            </div>
